...
In this example, a @@LINK(DatasetProducer) will process the descriptions in each FOOD_DES record and generate different datasets for different destination entities.
