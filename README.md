...
If you use [Maven](http://maven.apache.org), you'll need to add an entry for our repository to your `pom.xml` in order to obtain the `univocity-1.0.5` jar.
...
the following classes from the `univocity-1.0.5.jar`, as regular java applications:
